/*
 *build Copyright 2025 Google LLC
 *
...
android {
  namespace = "com.workflow327"
  compileSdk = 35

  defaultConfig {
    applicationId = "com.workflow327"
    minSdk = 31
    targetSdk = 35
    versionCode = 1
    versionName = "1.0.4"

    manifestPlaceholders["appAuthRedirectScheme"] = "com.workflow327"
