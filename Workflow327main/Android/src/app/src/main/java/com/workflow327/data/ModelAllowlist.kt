...
data class AllowedModel(
  ...
  fun toModel(): Model {
    // Construct HuggingFace download URL from modelId and modelFile
    ...
    // Default learn more URL for local models
    val learnMoreUrl = "https://huggingface.co/microsoft/phi-2"
